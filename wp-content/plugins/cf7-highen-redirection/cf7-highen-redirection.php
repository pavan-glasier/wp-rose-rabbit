...
class CF7Redirection{
    function __construct(){
		...
		if ( is_plugin_active( 'contact-form-7/wp-contact-form-7.php' ) ) {
			...
			function cf7_highen_my_admin_notice() { ?>
			<div class="error">
				<p><?php _e( '<b>Contact Form 7 - Redirect Page:</b> Contact Form 7 is not installed and / or active! Please install or activate: <a target="_blank" href="https://wordpress.org/plugins/contact-form-7/">Contact Form 7</a>.', 'cf7_highen' ); ?>
				</p>
			</div>
			<?php }
			add_action( 'admin_notices', 'cf7_highen_my_admin_notice' );
		}
    }    
}
